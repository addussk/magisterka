...
app.layout = html.Div(style={'backgroundColor':colors['background'] }, children=[
    ...
    html.Div(children="US Agriculture Exports (2011", style={'textAlign': 'center', 'color':colors['text']}),

    html.Div(children=generate_table(df2), style={'textAlign': 'center', 'color':colors['text'], 'backgroundColor': 'white'}),
